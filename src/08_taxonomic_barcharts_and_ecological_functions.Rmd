...
```{r}
normality_test(occurrence_table = legume_nodulating) -> actinorhizal_nodulating
...
rm(full_occurrence_table, legume_nodulating, actinorhizal_nodulating, AOB, NOB)
ls()
```
