...
- make two functions: lump_and_count(taxonomic_level) and plot_taxonomic_barchart,
- lump_and_count(taxonomic_level) must rename family to taxonomic_level
- so plot_taxonomic_barchart can be generic,
