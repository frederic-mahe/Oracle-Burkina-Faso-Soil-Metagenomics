...
. %>%
    ...
    count(samples, domain, phylum, class, order, family, genus,
...
There are cases of a duplicated level in some Silva entries:
```
...
load_clean_16S_occurrence_data(input) %>%
    ...
    add_taxonomic_data %>%
    add_taxonomic_ranks %>%
    group_taxa_per_sample -> taxa_per_sample_table
```
